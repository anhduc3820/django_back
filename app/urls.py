...
urlpatterns = [
    ...
    path('reset_staff/<staff_id>/', HodViews.reset_profile_staff, name="reset_staff"),
    ...
    path('reset_student/<student_id>/', HodViews.reset_profile_student, name="reset_student"),
